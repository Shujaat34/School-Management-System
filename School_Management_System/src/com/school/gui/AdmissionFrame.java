...
public class AdmissionFrame extends JFrame {
	...
	public AdmissionFrame() {
		...
		btnaddStudent.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					boolean iscontactUnique = validate.isNumberUnique(ab.getParentContact(), "admission",
							"Parent_Contact");
					boolean contactValidate = validate.contactNumberValidation(ab.getParentContact());

					if (isSnameString == false) {
						JOptionPane.showMessageDialog(AdmissionFrame.this, "Invalid Student Name", "Admission View",
								JOptionPane.DEFAULT_OPTION);
					} else if (isFnameString == false) {
						JOptionPane.showMessageDialog(AdmissionFrame.this, "Invalid Father's Name", "Admission View",
								JOptionPane.DEFAULT_OPTION);
					} else if (iscontactNumber == false) {
						JOptionPane.showMessageDialog(AdmissionFrame.this, "Contact is not a Number", "Admission View",
								JOptionPane.DEFAULT_OPTION);
					} else if (iscontactUnique == false) {
						JOptionPane.showMessageDialog(AdmissionFrame.this, "Contact can't be Duplicate",
								"Admission View", JOptionPane.DEFAULT_OPTION);
					} else if (contactValidate == false) {
						JOptionPane.showMessageDialog(AdmissionFrame.this, "Contact should have 11 Digits",
								"Admission View", JOptionPane.DEFAULT_OPTION);
					} else {
						int row = adao.addNewStudent(ab.getName(), ab.getFname(), ab.getDob(), ab.getParentContact(),
								cb.getId());

						if (row == 1) {
							JOptionPane.showMessageDialog(AdmissionFrame.this, "Student Admitted Successfully",
									"Admission View", JOptionPane.DEFAULT_OPTION);
							Integer status = cdao.updateStudentsAfterAddnew(cb.getStudents(), standard);

						} else {
							JOptionPane.showMessageDialog(AdmissionFrame.this, "Student Not Admitted", "Admission View",
									JOptionPane.ERROR_MESSAGE);
						}
						clear();
					}
				} catch (NullPointerException ex) {
					JOptionPane.showMessageDialog(AdmissionFrame.this, "Fill the Fields", "Admission View",
							JOptionPane.DEFAULT_OPTION);
				}
				populateTable();
			}
		...
		lblDashboard.setIcon(
				new ImageIcon(Dashboard.class.getResource("/com/school/images/icons8_student_male_48px_2.png")));
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] { "Nersary", "KG", "One", "Two", "Three", "Four",
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (row == 1) {
						...
						JOptionPane.showMessageDialog(AdmissionFrame.this, "Student Deleted Successful",
								"Admission View", JOptionPane.DEFAULT_OPTION);
					} else {
						JOptionPane.showMessageDialog(AdmissionFrame.this, "Student Not Deleted", "Admission View",
								JOptionPane.ERROR_MESSAGE);
					}
				} catch (Exception ex) {
					JOptionPane.showMessageDialog(AdmissionFrame.this, "Please Select a record", "Admission View",
							JOptionPane.DEFAULT_OPTION);
		...
		btnUpdateStudent.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (row == 1) {
					JOptionPane.showMessageDialog(AdmissionFrame.this, "Student Updated Successfully", "Admission View",
							JOptionPane.DEFAULT_OPTION);
				} else {
					JOptionPane.showMessageDialog(AdmissionFrame.this, "Student Not Updated", "Admission View",
							JOptionPane.ERROR_MESSAGE);
				}
				clear();
				populateTable();
		...
		cmboClass.setModel(new DefaultComboBoxModel(new String[] { "All", "Nersary", "KG", "One", "Two", "Three",
